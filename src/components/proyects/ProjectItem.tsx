...
export const ProjectItem = ({ project }: Props) => {
    const { name, description, html_url, tags, mainCode, mainCodeUrl, homepage } = project;
    ...
    return (
        ...
        >
            <input
                ...
                style={{ opacity: 0, background: "radial-gradient(600px circle at 352.5px 126px, rgba(97, 97, 97, 0.1), transparent 60%)" }}
            >
            </input>
            <div className="pointer-events-none absolute -inset-px rounded-md opacity-0 transition duration-300" style={{
                opacity: 0,
                background: "radial-gradient(600px circle at 265.5px 42px, rgba(97, 97, 97, 0.1), transparent 60%)"
            }}></div>
                ...
                <div className="flex w-full items-center justify-between">
                    <div className="flex items-center space-x-[10px]">
                        ...
                        />
                        {
                            ...
                            :
                            <p
                                className="group flex items-center gap-[6px] font-medium decoration-neutral-500 decoration-dotted underline-offset-[5px]"
                            ><span>{name}</span>
                                <svg
                                    stroke="currentColor"
                                    width={16}
                    ...
                    <a
                        href={html_url}
                        title={`Ver el repositorio ${name} en GitHub`}
                        target="_blank"
                        rel="noopener"
